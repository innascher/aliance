...
<body class="front-page">
  ...
  <div class="mobile-menu">
    <ul class="mobile-menu-nav">
      ...
      <li class="mobile-menu-nav-item">
        ...
        <ul class="mobile-submenu">
          <li class="submenu-item"><a class="submenu-item" href="#">Автомобильная химия</a></li>
          <li class="submenu-item"><a class="submenu-item" href="#">Бытовая химия</a></li>
          <li class="submenu-item"><a class="submenu-item" href="#">Дезинфицирующие средства</a></li>
          <li class="submenu-item"><a class="submenu-item" href="#">Пищевые аэрозоли</a></li>
          <li class="submenu-item"><a class="submenu-item" href="#">Косметическая продукция</a></li>
          <li class="submenu-item"><a class="submenu-item" href="#">Краски аэрозольные</a></li>
        </ul>
      </li>
      <li class="mobile-menu-nav-item">
        <a href="#" class="mobile-menu-nav-link">Собственные торговые марки</a>
        <ul class="mobile-submenu">
          <li class="submenu-item"><a class="submenu-item" href="#">Автохимия AG-Tech</a></li>
          <li class="submenu-item"><a class="submenu-item" href="#">Автохимия AP</a></li>
        </ul>
      </li>
      <li class="mobile-menu-nav-item">
    ...
    <div class="mobile-info">
      <div class="mobile-info-item"><img src="img/icons/geo.svg" alt="geo">
  ...
  <nav class="navbar">
    ...
    <a href="./" class="header-logo">
      <svg class="logo-svg" viewBox="0 0 140 44" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_8503_1602)">
        ...
        <defs>
          <clipPath id="clip0_8503_1602">
            <rect class="header-logo-path" width="140" height="44" fill="white" />
          </clipPath>
        </defs>
      </svg>
    </a>
    ...
    <button class="nav-btn btn" data-toggle="modal">
      <svg class="btn-svg" width="16" height="17" viewBox="0 0 16 17" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  <header class="header header-img">
    <div class="container">
      <div class="header-content">
        ...
        <h1 class="main-header">Комплексное обеспечение товарами и расходными материалами бизнеса</h1>
        <p class="subheader">Высокий уровень вовлечения представителей целевой аудитории является четким доказательством
          простого факта: высококачественный прототип будущего проекта напрямую зависит от анализа существующих
          паттернов поведения.</p>
        <button class="header-btn">Подробнее о компании</button>
      </div>
      ...
      <div class="swiper features-slider">
        <ul class="swiper-wrapper header-features">
          ...
          <li class="swiper-slide header-features-item">
            ...
            <p class="header-features-text">Поставки по всей России</p>
          </li>
          <li class="swiper-slide header-features-item">
  ...
  <section class="section section-light">
    <div class="container">
      ...
      <div class="swiper steps-slider">
        ...
        <div class="steps-btns primary-btns">
          <div class="steps-prev-btn primary-btn-prev">
            <img width="30" height="20" src="img/icons/arrow-prev.svg" alt="previous">
          </div>
          <div class="steps-next-btn primary-btn-next">
            <img width="30" height="20" src="img/icons/arrow-next.svg" alt="next">
          </div>
        </div>
        ...
        <!-- <div class="row cards-row">
          <div class="col-xl-4">
            <div class="card">
              ...
              <img class="card-img" width="454" src="img/avto-him.png" alt="avto-him">
            </div>
            ...
            <div class="card">
              ...
              <img class="card-img" src="img/dezinfect.png" alt="dezinfect">
            </div> 
          </div>
          ...
          <div class="col-xl-4">
            <div class="card">
              <div class="card-content">
                ...
                <img class="card-img" src="img/bit-him.png" alt="bit-him">
            </div>  
          ...
          <div class="col-xl-4">
            ...
            <div class="card">
              ...
              <img class="card-img" src="img/avto-him.png" alt="avto-him">
            </div>
          </div>            
      </div>   -->
        <a href="#" class="card">
  ...
  <section class="marks">
    <div class="container">
      <div class="separator"></div>
      <h2 class="section-title marks-section-title">собственные торговые марки</h2>

      <div class="marks-cards">

        <a href="#" class="marks-card">
          <img class="marks-img" src="img/AGTECH.svg" alt="Автохимия AG-Tech">
          <h4 class="marks-title">Автохимия AG-Tech</h4>
          <p class="marks-text">Для современного мира разбавленное изрядной долей эмпатии, рациональное мышление создаёт
            предпосылки для поставленных обществом задач.</p>
        </a>



        <a href="#" class="marks-card">
          <img class="marks-img" src="img/AP.svg" alt="Автохимия AP">
          <h4 class="marks-title">Автохимия AP</h4>
          <p class="marks-text">Для современного мира разбавленное изрядной долей эмпатии, рациональное мышление
      ...
      <!-- <div class="marks-cards">
        ...
        <a href="#" class="marks-card">
          <img class="marks-img" src="img/icons/AGTECH.png" alt="Автохимия AG-Tech">
          <div class="marks-card-content">
            <h4 class="marks-title">Автохимия AG-Tech</h4>
            <p class="marks-text">Для современного мира разбавленное изрядной долей эмпатии, рациональное мышление создаёт предпосылки для поставленных обществом задач.</p>
          </div>
        </a>

        <a href="#" class="marks-card">
          <img class="marks-img" src="img/icons/AP.png" alt="Автохимия AP">
          <div class="marks-card-content">
            <h4 class="marks-title">Автохимия AP</h4>
            <p class="marks-text">Для современного мира разбавленное изрядной долей эмпатии, рациональное мышление
              создаёт
    ...
    <div class="container">
      ...
      <div class="swiper blog-slider">
        ...
        <div class="swiper-wrapper blog-slider-wrapper">
          ...
          <a href="#" class="swiper-slide blog-item">
            <img class="blog-item-img" src="img/blog-img1.jpg" alt="#">
            <h3 class="blog-item-title">Современная методология разработки одухотворила всех причастных</h3>
            <p class="blog-item-text">Действия представителей оппозиции, превозмогая сложившуюся непростую экономическую
              ситуацию, в равной степени предоставлены...</p>
          </a>
          <a href="#" class="swiper-slide blog-item">
            <img class="blog-item-img" src="img/blog-img2.jpg" alt="#">
            <h3 class="blog-item-title">Сложно сказать, почему жизнь прекрасна</h3>
            <p class="blog-item-text">Сложно сказать, почему элементы политического процесса функционально разнесены на
        ...
        <div class="blog-slider-footer">
          <a href="#" class="btn-link">Весь блог</a>
          <div class="blog-btns primary-btns">
            <div class="blog-btn-prev primary-btn-prev">
              <img width="30" height="20" src="img/icons/arrow-prev.svg" alt="previous">
            </div>
            <div class="blog-btn-next primary-btn-next">
              <img width="30" height="20" src="img/icons/arrow-next.svg" alt="next">
            </div>
          </div>
        </div>
